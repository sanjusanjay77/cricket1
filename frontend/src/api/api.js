...
const API_URL =
  import.meta.env.VITE_API_URL || 'https://cricket1-mvsi.onrender.com/api';
...
export const Players = {
  list: (team_id) =>
    api.get('/players', { params: { team_id } }).then(r => r.data),
...
export const Matches = {
  ...
  setToss: (id, data) =>
    api.post(`/matches/${id}/toss`, data).then(r => r.data),

  startSecondInnings: (id) =>
    api.post(`/matches/${id}/second-innings`).then(r => r.data),
...
export const Innings = {
  scoreboard: (id) =>
    api.get(`/innings/${id}/scoreboard`).then(r => r.data),

  setBatsmen: (id, data) =>
    api.post(`/innings/${id}/set-batsmen`, data).then(r => r.data),

  swapStrike: (id) =>
    api.post(`/innings/${id}/swap-batsmen`).then(r => r.data),

  setBowler: (id, data) =>
    api.post(`/innings/${id}/set-bowler`, data).then(r => r.data),

  ball: (id, data) =>
    api.post(`/innings/${id}/ball`, data).then(r => r.data),

  undo: (id) =>
    api.post(`/innings/${id}/undo`).then(r => r.data),
};
