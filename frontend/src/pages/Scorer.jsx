  ...
  const loadFull = useCallback(async () => {
    try {
      ...
      const overFinished =
        ...
        serverCurrent.current_bowler_id == null;
      ...
      while (
        ...
        try {
          ...
          if (
            ...
            (
              result?.innings?.current_bowler_id == null &&
              Number(
                result?.innings?.total_balls || 0
              ) > 0 &&
              Number(
                result?.innings?.total_balls || 0
              ) % 6 === 0
